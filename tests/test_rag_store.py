...
from src.schemas import SignalAction, TradeExecutionRecord
...
def test_record_to_text_outcome_breakeven_exact_and_epsilon(memory_vector_store):
    ...
    assert "Outcome: BREAKEVEN" in memory_vector_store.record_to_text(
        record_float_artifact
    )
